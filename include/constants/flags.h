...
#define FLAG_BADGE09_GET (SYS_FLAGS + 0x4C)
#define FLAG_BADGE10_GET (SYS_FLAGS + 0x4D)
#define FLAG_BADGE11_GET (SYS_FLAGS + 0x4E)
#define FLAG_BADGE12_GET (SYS_FLAGS + 0x4F)
